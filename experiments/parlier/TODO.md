I want to use The Paillier cryptosystem. In node.js, i want to use 'homomorphicjs' npm module. In python, I want to use 'phe' module. The modules are already installed, do not install them. Create a node.js script, that
