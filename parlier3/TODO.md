I want to use The Paillier cryptosystem. In node.js, i want to use 'paillier-bigint' npm module. In python, I want to use 'lightphe' module. The modules are already installed, do not install them. Create a node.js script, that
